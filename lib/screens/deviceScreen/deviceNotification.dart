                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Device Maintenance Guide for User  ",style: text_StyleRoboto(backColor2, 14.0, FontWeight.w500),),
                          Icon(Icons.arrow_right_alt_outlined,color: backColor2,size: 18.0,)
                        ],
                      ),
                    ),
                    SizedBox(
